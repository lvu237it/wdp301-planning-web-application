...
router.patch('/:boardId/close', protect, isAdminBoard, boardController.closeBoard);

// 4. Xóa vĩnh viễn Board (chỉ creator)
router.delete('/:boardId', protect, isCreatorBoard, boardController.deleteBoard);

// 5. Mời thành viên vào Board (chỉ creator hoặc admin)
router.post('/:boardId/invite', protect, isAdminBoard, boardController.inviteBoardMember);
